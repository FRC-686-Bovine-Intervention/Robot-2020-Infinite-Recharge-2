...
public class ShooterCalcs {
    ...
    InterpolatingTreeMap<InterpolatingDouble, InterpolatingDouble> flywheelMap = new InterpolatingTreeMap<>();
    ...
    // public static Vector2d getTurretVelocity(int driveLASpeed){
